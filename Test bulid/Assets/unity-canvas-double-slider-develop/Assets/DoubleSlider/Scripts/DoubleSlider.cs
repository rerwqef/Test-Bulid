...
namespace TS.DoubleSlider
{
    ...
    public class DoubleSlider : MonoBehaviour
    {
        ...
        [SerializeField] public float _initialMinValue;
        [SerializeField] public float _initialMaxValue;
        ...
        public void MinValueChanged(float value)
        {
...
Debug.Log("min side");
        ...
        public   void MaxValueChanged(float value)
        {
